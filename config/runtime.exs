...
#
#     PHX_SERVER=true bin/post_finance_scraper start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :post_finance_scraper, PostFinanceScraperWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  #
  #     config :post_finance_scraper, PostFinanceScraper.Mailer,
